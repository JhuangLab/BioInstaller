...
[STAR](https://github.com/alexdobin/STAR) | 2.5.3a | Ultrafast universal RNA-seq aligner
...
[htslib](https://github.com/samtools/htslib) | 1.4 | C-library for handling high-throughput sequencing data
[samtools](https://github.com/samtools/samtools) | 1.4 | Mpileup and other tools for handling SAM, BAM, CRAM
[bcftools](https://github.com/samtools/bcftools) | 1.4 | Calling and other tools for handling VCF, BCF
...
[picard](https://github.com/broadinstitute/picard) | 2.9.0 | A set of Java command line tools for manipulating high-throughput sequencing (HTS) data and formats
...
---|---|---
[ANNOVAR](http://annovar.openbioinformatics.org/en/latest/) | 2017Mar11 | An efficient software tool to utilize update-to-date information to functionally annotate genetic variants detected from diverse genomes (including human genome hg18, hg19, hg38, as well as mouse, worm, fly, yeast and many others
...
ucsc_reffa | hg19 | The assembly sequence in one file per chromosome. Repeats from RepeatMasker and Tandem Repeats Finder (with period of 12 or less) are shown in lower case; non-repeating sequence is shown in upper case.
ucsc_reffa | hg38 | The assembly sequence in one file per chromosome. Repeats from RepeatMasker and Tandem Repeats Finder (with period of 12 or less) are shown in lower case; non-repeating sequence isshown in upper case.
